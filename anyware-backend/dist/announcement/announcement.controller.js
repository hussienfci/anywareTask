...
let AnnouncementController = class AnnouncementController {
    ...
    async createAnnounce(createAnnouncementDto) {
...
__decorate([
    (0, common_1.Post)('/addNewAnnounment'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_announcement_dto_1.CreateAnnouncementDto]),
    __metadata("design:returntype", Promise)
], AnnouncementController.prototype, "createAnnounce", null);
__decorate([
    (0, common_1.Get)('/Announcements'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AnnouncementController.prototype, "findAllAnnounce", null);
__decorate([
    (0, common_1.Get)('/Announcement/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AnnouncementController.prototype, "findOneById", null);
__decorate([
    (0, common_1.Patch)('/updateAnnouncement/:id'),
    __param(0, (0, common_1.Param)('id')),
